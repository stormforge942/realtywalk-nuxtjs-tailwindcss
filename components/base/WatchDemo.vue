...
<template>
  ...
  >
    <span
      class="flex justify-center items-center w-[calc(100%-40px)] h-full bg-white text-[#021d35] text-md font-semibold"
    >
      {{ $t('menu.watch_the_demo') }}
    </span>
    <span
      class="flex justify-center items-center w-[40px] h-full bg-secondary text-black"
    >
